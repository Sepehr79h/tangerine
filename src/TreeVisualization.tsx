...
//var data = {'nodes': [{'id': '1', 'data': {'label': 'Import libraries [1]', 'categoryColor': 'import'}}, {'id': '2', 'data': {'label': 'Load dataset [2]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_2_6'}, {'id': '3', 'data': {'label': 'Check missing values [3]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_2_6'}, {'id': '4', 'data': {'label': 'Dataset shape [4]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_2_6'}, {'id': '5', 'data': {'label': 'Dataset info [5]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_2_6'}, {'id': '6', 'data': {'label': 'Check object types [6]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_2_6'}, {'id': '7', 'data': {'label': 'Attrition value counts [7]', 'categoryColor': 'explore'}}, {'id': '8', 'data': {'label': 'Encode Attrition [8]', 'categoryColor': 'wrangle'}}, {'id': '9', 'data': {'label': 'Attrition pie chart [9]', 'categoryColor': 'explore'}}, {'id': '10', 'data': {'label': 'Check int64 types [10]', 'categoryColor': 'wrangle'}}, {'id': '11', 'data': {'label': 'Age distribution [11]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '12', 'data': {'label': 'Top 10 ages [12]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '13', 'data': {'label': 'Least common ages [13]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '14', 'data': {'label': 'StandardHours counts [14]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '15', 'data': {'label': 'EmployeeCount counts [15]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '16', 'data': {'label': 'Correlation heatmap [16]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '17', 'data': {'label': 'YearsAtCompany boxplot [17]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '18', 'data': {'label': 'BusinessTravel vs Attrition [18]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '19', 'data': {'label': 'Department vs Attrition [19]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '20', 'data': {'label': 'Department counts [20]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '21', 'data': {'label': 'Gender vs Attrition [21]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '22', 'data': {'label': 'JobRole vs Attrition [22]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '23', 'data': {'label': 'JobRole vs Income [23]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '24', 'data': {'label': 'EducationField vs Attrition [24]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '25', 'data': {'label': 'OverTime vs Attrition [25]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '26', 'data': {'label': 'EnvironmentSatisfaction counts [26]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_26'}, {'id': '27', 'data': {'label': 'Define features and target [27]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_27_31'}, {'id': '28', 'data': {'label': 'Encode categorical features [28]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_27_31'}, {'id': '29', 'data': {'label': 'Scale features [29]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_27_31'}, {'id': '30', 'data': {'label': 'Split dataset [30]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_27_31'}, {'id': '31', 'data': {'label': 'Print dataset shapes [31]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_27_31'}, {'id': '32', 'data': {'label': 'Train and evaluate models [32]', 'categoryColor': 'model'}}, {'id': 'group_2_6', 'data': {'label': 'Initial Data Preparation [2-6]', 'categoryColor': 'wrangle'}}, {'id': 'group_11_26', 'data': {'label': 'Comprehensive Data Analysis [11-26]', 'categoryColor': 'explore'}}, {'id': 'group_27_31', 'data': {'label': 'Preprocessing for Modeling [27-31]', 'categoryColor': 'wrangle'}}], 'edges': [{'source': '2', 'target': '3'}, {'source': '2', 'target': '4'}, {'source': '2', 'target': '5'}, {'source': '2', 'target': '6'}, {'source': '2', 'target': '7'}, {'source': '2', 'target': '8'}, {'source': '8', 'target': '9'}, {'source': '8', 'target': '10'}, {'source': '8', 'target': '11'}, {'source': '8', 'target': '12'}, {'source': '8', 'target': '13'}, {'source': '8', 'target': '14'}, {'source': '8', 'target': '15'}, {'source': '8', 'target': '16'}, {'source': '11', 'target': '16'}, {'source': '16', 'target': '17'}, {'source': '16', 'target': '18'}, {'source': '16', 'target': '19'}, {'source': '16', 'target': '21'}, {'source': '16', 'target': '22'}, {'source': '16', 'target': '23'}, {'source': '16', 'target': '24'}, {'source': '16', 'target': '25'}, {'source': '16', 'target': '26'}, {'source': '16', 'target': '27'}, {'source': '17', 'target': '18'}, {'source': '18', 'target': '19'}, {'source': '19', 'target': '20'}, {'source': '19', 'target': '21'}, {'source': '21', 'target': '22'}, {'source': '22', 'target': '23'}, {'source': '23', 'target': '24'}, {'source': '24', 'target': '25'}, {'source': '25', 'target': '26'}, {'source': '26', 'target': '27'}, {'source': '27', 'target': '28'}, {'source': '27', 'target': '29'}, {'source': '27', 'target': '30'}, {'source': '28', 'target': '29'}, {'source': '29', 'target': '30'}, {'source': '30', 'target': '32'}, {'source': '30', 'target': '31'}, {'source': '8', 'target': 'group_11_26'}, {'source': '16', 'target': 'group_27_31'}, {'source': '26', 'target': 'group_27_31'}, {'source': 'group_11_26', 'target': '27'}, {'source': 'group_27_31', 'target': '32'}, {'source': 'group_2_6', 'target': '8'}, {'source': 'group_11_26', 'target': 'group_27_31'}, {'source': 'group_2_6', 'target': '7'}]}
// var data = {'nodes': [{'id': '1', 'data': {'label': 'Import libraries [1]', 'categoryColor': 'import'}}, {'id': '2', 'data': {'label': 'Load dataset [2]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_2_6'}, {'id': '3', 'data': {'label': 'Check missing values [3]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_2_6'}, {'id': '4', 'data': {'label': 'Dataset shape [4]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_2_6'}, {'id': '5', 'data': {'label': 'Dataset info [5]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_2_6'}, {'id': '6', 'data': {'label': 'Check object types [6]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_2_6'}, {'id': '7', 'data': {'label': 'Attrition value counts [7]', 'categoryColor': 'explore'}}, {'id': '8', 'data': {'label': 'Encode Attrition [8]', 'categoryColor': 'wrangle'}}, {'id': '9', 'data': {'label': 'Attrition pie chart [9]', 'categoryColor': 'explore'}}, {'id': '10', 'data': {'label': 'Check int64 types [10]', 'categoryColor': 'wrangle'}}, {'id': '11', 'data': {'label': 'Age distribution [11]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_15'}, {'id': '12', 'data': {'label': 'Top 10 ages [12]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_15'}, {'id': '13', 'data': {'label': 'Least common ages [13]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_15'}, {'id': '14', 'data': {'label': 'StandardHours counts [14]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_15'}, {'id': '15', 'data': {'label': 'EmployeeCount counts [15]', 'categoryColor': 'explore'}, 'parentNode': 'group_11_15'}, {'id': '16', 'data': {'label': 'Drop columns and correlation heatmap [16]', 'categoryColor': 'wrangle'}}, {'id': '17', 'data': {'label': 'YearsAtCompany boxplot [17]', 'categoryColor': 'explore'}, 'parentNode': 'group_17_26'}, {'id': '18', 'data': {'label': 'BusinessTravel vs Attrition [18]', 'categoryColor': 'explore'}, 'parentNode': 'group_17_26'}, {'id': '19', 'data': {'label': 'Department vs Attrition [19]', 'categoryColor': 'explore'}, 'parentNode': 'group_17_26'}, {'id': '20', 'data': {'label': 'Department counts [20]', 'categoryColor': 'explore'}, 'parentNode': 'group_17_26'}, {'id': '21', 'data': {'label': 'Gender vs Attrition [21]', 'categoryColor': 'explore'}, 'parentNode': 'group_17_26'}, {'id': '22', 'data': {'label': 'JobRole vs Attrition [22]', 'categoryColor': 'explore'}, 'parentNode': 'group_17_26'}, {'id': '23', 'data': {'label': 'JobRole vs MonthlyIncome [23]', 'categoryColor': 'explore'}, 'parentNode': 'group_17_26'}, {'id': '24', 'data': {'label': 'EducationField vs Attrition [24]', 'categoryColor': 'explore'}, 'parentNode': 'group_17_26'}, {'id': '25', 'data': {'label': 'OverTime vs Attrition [25]', 'categoryColor': 'explore'}, 'parentNode': 'group_17_26'}, {'id': '26', 'data': {'label': 'EnvironmentSatisfaction counts [26]', 'categoryColor': 'explore'}, 'parentNode': 'group_17_26'}, {'id': '27', 'data': {'label': 'Define features and target [27]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_27_31'}, {'id': '28', 'data': {'label': 'Encode categorical features [28]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_27_31'}, {'id': '29', 'data': {'label': 'Scale features [29]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_27_31'}, {'id': '30', 'data': {'label': 'Train-test split [30]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_27_31'}, {'id': '31', 'data': {'label': 'Print dataset shapes [31]', 'categoryColor': 'wrangle'}, 'parentNode': 'group_27_31'}, {'id': '32', 'data': {'label': 'Train and evaluate models [32]', 'categoryColor': 'model'}}, {'id': 'group_2_6', 'data': {'label': 'Initial Data Preparation [2-6]', 'categoryColor': 'wrangle'}}, {'id': 'group_11_15', 'data': {'label': 'Employee Demographics Analysis [11-15]', 'categoryColor': 'explore'}}, {'id': 'group_17_26', 'data': {'label': 'Attrition Factors Exploration [17-26]', 'categoryColor': 'explore'}}, {'id': 'group_27_31', 'data': {'label': 'Feature Engineering Steps [27-31]', 'categoryColor': 'wrangle'}}], 'edges': [{'source': '2', 'target': '3'}, {'source': '2', 'target': '4'}, {'source': '2', 'target': '5'}, {'source': '2', 'target': '6'}, {'source': '2', 'target': '7'}, {'source': '2', 'target': '8'}, {'source': '8', 'target': '9'}, {'source': '8', 'target': '10'}, {'source': '8', 'target': '11'}, {'source': '8', 'target': '12'}, {'source': '8', 'target': '13'}, {'source': '8', 'target': '14'}, {'source': '8', 'target': '15'}, {'source': '8', 'target': '16'}, {'source': '11', 'target': '16'}, {'source': '16', 'target': '17'}, {'source': '16', 'target': '18'}, {'source': '16', 'target': '19'}, {'source': '16', 'target': '21'}, {'source': '16', 'target': '22'}, {'source': '16', 'target': '23'}, {'source': '16', 'target': '24'}, {'source': '16', 'target': '25'}, {'source': '16', 'target': '26'}, {'source': '16', 'target': '27'}, {'source': '17', 'target': '18'}, {'source': '18', 'target': '19'}, {'source': '19', 'target': '20'}, {'source': '19', 'target': '21'}, {'source': '21', 'target': '22'}, {'source': '22', 'target': '23'}, {'source': '23', 'target': '24'}, {'source': '24', 'target': '25'}, {'source': '25', 'target': '26'}, {'source': '26', 'target': '27'}, {'source': '27', 'target': '28'}, {'source': '27', 'target': '29'}, {'source': '27', 'target': '30'}, {'source': '28', 'target': '29'}, {'source': '29', 'target': '30'}, {'source': '30', 'target': '32'}, {'source': '30', 'target': '31'}, {'source': 'group_17_26', 'target': 'group_27_31'}, {'source': '26', 'target': 'group_27_31'}, {'source': 'group_27_31', 'target': '32'}, {'source': 'group_2_6', 'target': '7'}, {'source': 'group_11_15', 'target': '16'}, {'source': 'group_2_6', 'target': '8'}, {'source': '16', 'target': 'group_17_26'}, {'source': 'group_17_26', 'target': '27'}, {'source': '16', 'target': 'group_27_31'}, {'source': '8', 'target': 'group_11_15'}]}
...
const TreeVisualization: React.FC<TreeVisualizationProps & { isLoading: boolean }> = ({ treeData, notebookPanel, isLoading }) => {
  ...
  const executeCell = async (id: string) => {
    ...
    if (notebookPanel) {
        const cell = notebookPanel.content.widgets.find((w) => (w as any).prompt === id);
        console.log(cell);
        if (cell) {
            await NotebookActions.run(notebookPanel.content, notebookPanel.sessionContext);
            ...
            if (newId && newId !== id) {
              // Update the ID in the data variable
              ...
              // Update the edges in the data variable
              ...
              const updatedVisibleNodes = data.nodes.filter(node => !node.parentNode);
              setVisibleNodes(updatedVisibleNodes);
              setVisibleEdges(data.edges.filter(edge => updatedVisibleNodes.find(node => node.id === edge.source) && updatedVisibleNodes.find(node => node.id === edge.target)));
            }
        }
    }
};
